import 'package:bonfire/util/quadtree_collision/custom_quadtree_collision_detection.dart';
import 'package:bonfire/util/quadtree_collision/custom_tree_broadphase.dart';
...
mixin CustomHasQuadTreeCollisionDetection<W extends World> on FlameGame<W>
    implements HasCollisionDetection<CustomQuadTreeBroadphase> {
  ...
  set collisionDetection(
    CollisionDetection<ShapeHitbox, CustomQuadTreeBroadphase> cd,
  ) {
